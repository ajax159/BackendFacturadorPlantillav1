...
public class FacClienteModel extends GlobalEntity implements Serializable{
    ...
    @NotEmpty
    @Column(name = "cli_tipopersona")
    private String cliTipoPersona;

    @NotEmpty
    @Column(name = "cli_nombrecompleto")
    private String cliNombreCompleto;

    @NotEmpty
    @Column(name = "cli_ndocumento")
    private String cliNdocumento;
