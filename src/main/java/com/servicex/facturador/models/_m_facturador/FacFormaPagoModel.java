...
@Entity
@Data
@Table(name = "fac_formapago")
public class FacFormaPagoModel extends GlobalEntity implements Serializable{
    ...
    @Column(name = "fpa_descripcion")
    private String fpaDescripcion;
